...
ProposeOccurenceBiasingOperation( const G4Track* track,
  ...
  if ( callingProcess  &&  callingProcess->GetWrappedProcess() && callingProcess->GetWrappedProcess()->GetProcessName() == "muonNuclear"  ) {
      ...
      BiasingOperation* operation = fBiasingOperation[callingProcess];
